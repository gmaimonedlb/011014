...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->data['text_report_product_purchased_percent'] = $this->language->get('text_report_product_purchased_percent');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
            ...
            $this->data['report_product_purchased_percent'] = $this->url->link('report/product_purchased_percent', 'token=' . $this->session->data['token'], 'SSL');
