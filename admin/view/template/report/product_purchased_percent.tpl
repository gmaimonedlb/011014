        ...
        <tr>
          ...
          <td><?php echo $entry_date_end; ?>
            <input type="text" name="filter_date_end" value="<?php echo $filter_date_end; ?>" id="date-end" size="12" />
              <input type="hidden" name="id_found" value="<?php echo $id_found; ?>" id="id_found" size="12" />
          </td>
          <td><?php echo $entry_status; ?>
            ...
            <td style="text-align: right;"><a onclick="filter();" class="button"><?php echo $button_filter; ?></a>
                <a onclick="email();" class="button"><?php echo "Email"; ?></a></td>
        </tr>
      </table>
      <table class="list">
        <thead>
...
function filter() {
	url = 'index.php?route=report/product_purchased_percent/foundation&token=<?php echo $token; ?>';
    ...
    var id_found = $('input[name=\'id_found\']').attr('value');

    if (id_found != "") {
        url += '&id_found=' + encodeURIComponent(id_found);
    }

    location = url;
}
    function email() {
        url = 'index.php?route=report/product_purchased_percent/email&token=<?php echo $token; ?>';
