          ...
          <li><a class="parent"><?php echo $text_product; ?></a>
            <ul>
              <li><a href="<?php echo $report_product_viewed; ?>"><?php echo $text_report_product_viewed; ?></a></li>
                ...
                <li><a href="<?php echo $report_product_purchased_percent; ?>"><?php echo  $text_report_product_purchased_percent; ?></a></li>
                <li><a href="<?php echo $report_customer_reward; ?>">Jess Report</a></li>
